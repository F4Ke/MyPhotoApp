...
public class Utils {
    ...
    public static Matrix calcul_matrix(int viewWidth, int viewHeight, AutoFitTextureView mTextureView, Size mPreviewSize, Activity activity)
    {
